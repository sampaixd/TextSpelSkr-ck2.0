...
namespace TextSpelSkräck2._0
{
    internal class Help
    {
        public static void HelpMenu()
        {
            ...
            Console.WriteLine("You can navigate your inventory and documents using W/S or arrow up/arrow down. You can read the content \n" +
                "of a document by pressing enter while having it selected. You exit the intentory/documents by pressing escape");
        }
    }
}
